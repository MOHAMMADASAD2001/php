...
if (count($_POST)>0) {
  mysqli_query($conn,"UPDATE trainees SET trainees_name='" . $_POST['trainees_name'] ."', age='" . $_POST['age'] ."' WHERE id=$id");
...
<div class="form-element my-4">
  <input type="text"  class="form-control" name="trainees_name" placeholder="Trainees Name:" value="<?php echo $row['trainees_name']?>">
</div>
<div class="form-element my-4">

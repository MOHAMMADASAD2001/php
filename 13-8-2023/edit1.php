...
if (count($_POST)>0) {
  $sql = "DELETE FROM trainees WHERE id ='" .$_GET["id"] ."'";
}
...
<div class="form-element my-4">
  <input type="text"  class="form-control" name="trainees_name" placeholder="First title:" value="<?php echo $row['trainees_name']?>">
</div>
<div class="form-element my-4">
...
<div class="form-element my-4">
 <select name="type" class="form-control"  > >
  ...
  <option value="tlerar">tlerar</option>
  <option value="scifi">scifi</option>
  
 </select> 
</div>
<div class="form-element my-4">
  <input type="text"  class="form-control" name="desc"  placeholder="book description:" >
</div>
<div class="form-element">
<input type="submit" class="btn btn-success" name="creat" value="Add book">
</div>
</form> -->
